...
let nts = {
    'about': {
        cnt: `<p class="tit">Jerry OS</p>
            <p>Welcome<br /><br />
            This is the future of finance.<br /><br />
            You are now at home for all things Solana.<br />`,
        btn: [
...
let apps = {
    ...
    telegram: {
        ...
        load: () => {
            $('#win-telegram')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://web.telegram.org/a/" frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    twitter: {
        init: () => {
        ...
        load: () => {
            $('#win-twitter')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://x.com/" frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    cryptobubbles: {
        init: () => {
        ...
        load: () => {
            $('#win-cryptobubbles')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://cryptobubbles.net/ " frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    sol: {
        init: () => {
        ...
        load: () => {
            $('#win-sol')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://solana.com/news  " frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    solana: {
        init: () => {
        ...
        load: () => {
            $('#win-solana')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://www.starlaunch.com/  " frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    solchat: {
        init: () => {
        ...
        load: () => {
            $('#win-solchat')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://www.solchat.io/  " frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    solbot: {
        init: () => {
        ...
        load: () => {
            $('#win-solbot')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://www.solchat.io/  " frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    solgames: {
        init: () => {
        ...
        load: () => {
            $('#win-solgames')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://www.solchat.io/  " frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    vscode: {
        init: () => {
...
(c) Jerry Corporation
        ...
        run: () => {
            ...
            var newD = document.createElement('div');
            newD.innerText = `C:\\JerryOS\\System32> ${command}`;
            elt.appendChild(newD);
            if (command == 'exit') {
                hidewin('terminal');
                input.val('');
...
let icon = {
    ...
    frenpet:'frenpet.png',
    basepaint:'basepaint.png',
    telegram:'telegram.svg',
    twitter:'x.svg',
    cryptobubbles:'cryptobubbles.png',
    sol:'sol.png',
    solana:'solana.png',
    solchar:'solchat.png',
    solgames:'solgames.png',
    solbot:'solbot.png'
}
